...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        ...
        self.groupBox_2.setTitle(_translate("Widget", "OCR识别结果"))
        self.label_2.setText(_translate("Widget", "TextLabel"))
        self.pushButton.setText(_translate("Widget", "打开图片"))
        self.pushButton_2.setText(_translate("Widget", "OCR识别"))
        self.pushButton_3.setText(_translate("Widget", "保存OCR识别结果"))
        self.pushButton_4.setText(_translate("Widget","批量读取"))
